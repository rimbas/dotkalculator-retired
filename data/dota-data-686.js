...
DotaData.addVersion( "6.86c", 
{
	...
	"Items": {
		...
		"veil_of_discord": {
			...
			"Cost": 2270,
			"Components": ["helm_of_iron_will", "null_talisman", "robe", "robe"],
			"Section": "Caster",
			"SectionIndex": 2,
		...
		"aether_lens": {
			"Name": "Aether lens",
			"Cost": 2300,
			"Components": ["energy_booster", "ring_of_health", "cloak"],
			"Section": "Caster",
			"SectionIndex": 3,
			"Mana": 250,
		...
		"dragon_lance": {
			"Name": "Dragon lance",
			"Cost": 1875,
			"Components": ["ogre_axe", "quarterstaff"],
			"Section": "Artifacts",
			"SectionIndex": 2,
			"Strength": 10,
			"Damage": 10,
	...
	"Abilities": {
		...
		"huskar_berserkers_blood":{
			...
			"Charges": 0,
			"ChargesMax": 90,
			"AttackSpeed": function(){ return this.Level > 0 ? Math.floor(this.Charges / this.ChargesMax * (168 + this.Level * 28) ) : 0 },
		...
		"invoker_invoke": {
			...
			"Strength": function() {
				if (this.heroRef)
					return this.heroRef.Meta.Level >= 25 ? 6 : 0;
				return 0
			},
			"Agility": function() {
				if (this.heroRef)
		...
		"lina_fiery_soul": {
			...
			"ChargesMax": 3,
			"ChargesSemantic": "Stacks",
			"AttackSpeed": function() { return (25 + this.Level * 15) * this.Stacks },
			"MovementSpeedPercentage": function() { return (0.04 + this.Level * 0.01) * this.Stacks }, 	
		},
		"lina_laguna_blade": {
			"Name": "Laguna blade",
			"Class": "Ultimate",
		...
		"troll_warlord_berserkers_rage": {
			...
			"AttackType": function(){ return this.Charges ? "Ranged" : "Melee" },
			"Range": function(){ return this.Charges ? -372 : 0 },
		...
		"troll_warlord_whirling_axes_ranged": {
			"Name": "Whirling axes",
			"Image": function(){
				if (this.heroRef && this.heroRef.AbilityIds["troll_warlord_berserkers_rage"])
					return this.heroRef.AbilityIds["troll_warlord_berserkers_rage"].Charges > 0 ? "troll_warlord_whirling_axes_melee" : "troll_warlord_whirling_axes_ranged"
	...
	"Buffs": {
		...
		"wisp_tether_buff": {
			...
			"Level": 0,
			"LockedLevel": true,
			"MovementSpeedPercentage": function(){ return 0.13 + 0.01 * this.Level }	
		},
